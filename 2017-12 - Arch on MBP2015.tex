...
\begin{headerborder}
    ...
    \begin{tabularx}{\textwidth}{lR}
        \href{https://an7ar35.bitbucket.io/}{\raisebox{-0.25\height}{\includegraphics[scale=0.25]{common/avatar.png}} An7ar35} (Dec 2017) &
        \raisebox{-0.25\height}{\includegraphics[scale=0.15]{common/licenses/by-nc-sa_eu.png}}
    \end{tabularx}
\end{headerborder}
...
\href{https://wiki.archlinux.org/index.php/mkinitcpio}{\code{mkinitcpio}}
...
\terminalcmd{yaourt -S macfanctld}
    \block{\href{https://github.com/MikaelStrom/macfanctld}{macfanctld} controls the mbp fans.}
\terminalcmd{sudo systemctl enable macfanctld.service}
    \block{Turns on the service}

\subsubsection{Processor}

\terminalcmd{intel-ucode}
