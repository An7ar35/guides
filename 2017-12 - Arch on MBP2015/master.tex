...
\subsubsection{Video: Intel's IGU}
...
Assuming you have both the AMD and Intel sections done:
...
To get brightness control to work, a patched version of the \code{apple-gmux} kernel module is required. The vanilla module does \href{https://bugzilla.kernel.org/show_bug.cgi?id=105051#c37}{not work} as of Linux kernel version 4.14.8-1. Perhaps later versions will eventually.
