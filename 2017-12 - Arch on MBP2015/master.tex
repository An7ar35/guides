...
To make function keys be used as first keys. i.e.: Pressing \key{F1} key alone will behave like F1 and pressing \key{Fn}+\key{F1} will act as special key (brightness down).
...
\vspace*{1em}
\textbf{\textcolor{textgrey}{\underline{Swap the} \key{⌥} \underline{and} \key{⌘} \underline{keys}}}
...
\textbf{\textcolor{textgrey}{\underline{For KDE}}}
...
\subsection{Printing/Scanning //TODO}
...
\textbf{\textcolor{textgrey}{\underline{Terminal}}}
	\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
		\item \code{p7zip}
		\item \code{unrar}
		\item \code{zip}
...
\hspace{4em}
\begin{varwidth}[t]{.5\textwidth}
	\textbf{\textcolor{textgrey}{\underline{GUI}}}
	\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*]
