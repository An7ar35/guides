...
To get brightness control to work, a patched version of the \code{apple-gmux} kernel module is required. The vanilla module does \href{https://bugzilla.kernel.org/show_bug.cgi?id=105051#c37}{not work}.
...
If the brightness control breaks after a kernel update the patch must be run again to get the functionality back. Hopefully this won''t be an issue for long in future kernel releases.
